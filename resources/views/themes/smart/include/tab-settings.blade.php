<div class="settings-panel">
	...
	<hr class="mb-0 mt-4">
		<div class=&quot;fs-xs text-muted p-2 alert alert-warning mt-3 mb-2&quot;>
			<i class=&quot;{{config('theme.smartadmin.iconPrefix')}} fa-exclamation-triangle text-warning mr-2&quot;></i>The settings below uses localStorage to load
