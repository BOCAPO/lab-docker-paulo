		...
		<li>
			<a href="#" class="app-list-item hover-white">
				<span class="icon-stack">
					...
					<i class="{{config('theme.smartadmin.iconPrefix')}} fa-keyboard icon-stack-1x color-info-50"></i>
				</span>
				<span class="app-list-name">
					Notes
				</span>
		...
		<li>
			<a href="#" class="app-list-item hover-white">
				<span class="icon-stack">
					...
					<i class="{{config('theme.smartadmin.iconPrefix')}} fa-dot-circle icon-stack-1x text-white opacity-85"></i>
				</span>
				<span class="app-list-name">
					Photos
				</span>
		...
		<li>
			<a href="#" class="app-list-item hover-white">
				<span class="icon-stack">
					...
					<i class="{{config('theme.smartadmin.iconPrefix')}} fa-globe icon-stack-1x text-white opacity-85"></i>
				</span>
				<span class="app-list-name">
					Maps
				</span>
		...
		<li>
			<a href="#" class="app-list-item hover-white">
				<span class="icon-stack">
					...
					<i class="{{config('theme.smartadmin.iconPrefix')}} fa-comment-alt icon-stack-1x text-white"></i>
				</span>
				<span class="app-list-name">
					Chat
				</span>
		...
		<li>
			<a href="#" class="app-list-item hover-white">
				<span class="icon-stack">
					...
					<i class="{{config('theme.smartadmin.iconPrefix')}} fa-phone icon-stack-1x text-white"></i>
				</span>
				<span class="app-list-name">
					Phone
				</span>
		...
		<li>
			<a href="#" class="app-list-item hover-white">
				<span class="icon-stack">
					...
					<i class="{{config('theme.smartadmin.iconPrefix')}} fa-chart-line icon-stack-1x text-white"></i>
				</span>
				<span class="app-list-name">
					Projects
				</span>
